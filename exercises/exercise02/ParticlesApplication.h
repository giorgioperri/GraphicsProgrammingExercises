...
private:
    ...
    // Emit a new particle
    void EmitParticle(const glm::vec2& position, const float size, const float birth, const float duration, Color color, glm::vec2 velocity);
...
private:
    ...
    ShaderProgram::Location m_gravityLocation;
};
